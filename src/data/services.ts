...
// Service icons as React components using JSX
const StrategyIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return React.createElement('svg', {
    ...
    children: React.createElement('path', {
      d: 'M2 9.364V2h7.364v7.364H2zm12.636 0V2H22v7.364h-7.364zm0 12.636v-7.364H22v7.364h-7.364zM2 22v-7.364h7.364V22H2z'
    })
  });
};
...
const DigitalIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return React.createElement('svg', {
    ...
    strokeLinejoin: 'round',
    children: [
      React.createElement('rect', { key: 'rect', x: '2', y: '3', width: '20', height: '14', rx: '2', ry: '2' }),
...
const ChangeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return React.createElement('svg', {
    ...
    strokeLinejoin: 'round',
    children: [
      React.createElement('path', { key: 'path1', d: 'M21 2v6h-6' }),
      React.createElement('path', { key: 'path2', d: 'M3 12a9 9 0 0 1 15-6.7L21 8' }),
      React.createElement('path', { key: 'path3', d: 'M3 22v-6h6' }),
      React.createElement('path', { key: 'path4', d: 'M21 12a9 9 0 0 1-15 6.7L3 16' })
    ]
  });
};
